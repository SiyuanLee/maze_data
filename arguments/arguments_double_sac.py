...
def get_args_point():
    ...
    parser.add_argument('--action-l2', type=float, default=0.2, help='l2 reg')
    ...
    parser.add_argument('--resume-path', type=str,
                        default='saved_models/PointMaze1-v1_May27_20-56-12',
                        help='resume path')
    ...
    parser.add_argument('--d_range', type=float, default=2.0, help='high-level action space (direction) range')
    parser.add_argument('--update_interval', type=int, default=10, help="every n episodes to update phi once")
...
def get_args_ant():
    ...
    parser.add_argument('--test', type=str, default='AntMaze1-v1')
    ...
    parser.add_argument('--resume-path', type=str, default='saved_models/AntMaze1-v1_Jun02_22-34-39', help='resume path')

    # add for hier policy
    parser.add_argument('--save', type=bool, default=True, help='save model and tensorboard data')
    parser.add_argument('--animate', type=bool, default=False)
    parser.add_argument("--eval", type=bool, default=False)
    parser.add_argument("--xy_goal", type=bool, default=True, help="use xy goal space in create_maze")
    parser.add_argument('--eval_interval', type=int, default=50, help="every n episodes to eval once")
    parser.add_argument('--c', type=int, default=10, help="interval of high-level action")
    parser.add_argument('--contrastive_phi', type=bool, default=True, help='learn feature with contrastive loss')
    ...
    parser.add_argument('--start_epoch', type=int, default=300, metavar='N',
                        help='Epochs sampling random actions (default: 50)')
    parser.add_argument('--low_start_epoch', type=int, default=50, metavar='N',
                        help='Epochs sampling random actions for low-level (default: 50)')
    parser.add_argument('--target_update_interval', type=int, default=1, metavar='N',
                        help='Value target update per no. of updates per step (default: 1)')
