...
def get_args_point():
    ...
    parser.add_argument('--test', type=str, default='PointMaze1-v1')
    parser.add_argument('--n-epochs', type=int, default=7200, help='the number of epochs to train the agent')
    ...
    parser.add_argument('--resume-path', type=str,
                        default='saved_models/PointMaze1-v1_May15_10-04-32',
                        help='resume path')
    ...
    parser.add_argument("--xy_goal", type=bool, default=True, help="use only two dimension goal space for navigation")
    parser.add_argument('--eval_interval', type=int, default=10, help="every n episodes to eval once")
    parser.add_argument('--c', type=int, default=10, help="interval of high-level action")
    parser.add_argument('--hi_random_eps', type=float, default=0.0, help="prob of taking nearby subgoal")
    parser.add_argument('--hi_n_batches', type=int, default=50, help='the times to update high-level network')
    ...
    parser.add_argument('--hi_layer', type=int, default=3, help='number of layers for critic of high-level')
...
def get_args_ant():
    ...
    parser.add_argument('--animate', type=bool, default=False)
    parser.add_argument("--eval", type=bool, default=False)
    parser.add_argument("--xy_goal", type=bool, default=False, help="use only two dimension goal space for ant env")
    parser.add_argument('--min_dist', type=float, default=10., help="min dist for adding edge")
    parser.add_argument('--eval_interval', type=int, default=10, help="every n episodes to eval once")
    parser.add_argument('--percept_thres', type=float, default=1., help="perception threshold of building graph")
    parser.add_argument('--follow_thres', type=float, default=1., help="threshold of follow path")
    parser.add_argument('--start_build', type=int, default=500, help="episode to start build graph")
    parser.add_argument('--hash_k_dim', type=int, default=128, help='key size of simhash')
