...
def get_args_point():
    ...
    parser.add_argument('--seed', type=int, default=130, help='random seed')
    ...
    parser.add_argument('--resume-path', type=str,
                        default='saved_models/PointMaze1-v1_Jul10_21-35-18',
                        help='resume path')
    ...
    parser.add_argument('--gradient_flow', type=bool, default=False,
                        help='gradient flow between high-level policy and feature')
    parser.add_argument('--gradient_flow_value', type=bool, default=False,
                        help='slow feature as a embedding of value function')
    parser.add_argument('--abs_range', type=float, default=10.0, help='range of high-level action space')
    ...
    parser.add_argument("--weight_decay", type=float, default=1e-5, help='weight decay to low critic')
...
def get_args_ant():
    ...
    # Will be considered only if resume is True
    parser.add_argument('--resume-epoch', type=int, default=0, help='resume epoch')
    parser.add_argument('--resume-path', type=str, default='saved_models/AntMaze1Test-v1_Dec03_15-04-40', help='resume path')
...
def get_args_swimmer():
    parser = argparse.ArgumentParser()
    # the environment setting
    parser.add_argument('--env-name', type=str, default='SwimmerMaze1-v1', help='the environment name')
    parser.add_argument('--test', type=str, default='SwimmerMaze1Test-v1')
    parser.add_argument('--n-epochs', type=int, default=20000, help='the number of epochs to train the agent')
    parser.add_argument('--n-batches', type=int, default=200, help='the times to update the network')
    parser.add_argument('--seed', type=int, default=262, help='random seed')
    ...
    # Will be considered only if resume is True
    parser.add_argument('--resume-epoch', type=int, default=0, help='resume epoch')
    parser.add_argument('--resume-path', type=str, default='saved_models/AntPush-v1_Jun16_12-52-50', help='resume path')
    ...
    parser.add_argument('--c', type=int, default=20, help="interval of high-level action")
    parser.add_argument('--gradient_flow', type=bool, default=False, help='end-to-end learn feature and policy')
    parser.add_argument('--abs_range', type=float, default=50.0, help='range of high-level action space')
    parser.add_argument('--use_target', type=bool, default=False, help='use target network for learning feature')
    parser.add_argument('--early_stop', type=bool, default=True, help='early stop the learning of low-level')
    parser.add_argument('--low_reward_coeff', type=float, default=0.01, help='low-level reward coeff')
    # parser.add_argument('--add_noise', type=bool, default=False, help='add 20 dim noise to obs')
...
def get_args_chain():
    ...
    parser.add_argument('--n-batches', type=int, default=200, help='the times to update the network')
    parser.add_argument('--seed', type=int, default=179, help='random seed')
    ...
    parser.add_argument("--image", type=bool, default=False, help='use image input')
    parser.add_argument("--old_sample", type=bool, default=True, help='sample the absolute goal in the abs_range')
